...
def run_alexa():
    ...
    with sr.Microphone() as source:
        ...
        engine_talk('hearing you.... ')
        recordedsound=recognizer.listen(source)
    
    try:
        command=recognizer.recognize_google(recordedsound,language='en-in')
        ...
        if 'hello' in command :
            print('hello how can i helpp you Shreya??')
            engine_talk('hello, how can i help you Shreya??')
...
print('\n')
print("hello, i am mini alexa how can i help you...Shreya??")
engine_talk ("hello i am mini alexa how can i help you ...Shreya ")
while True:
    run_alexa()  
